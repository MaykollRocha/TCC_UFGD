<link rel="stylesheet" href="/static/app/css/toomcook3/styles.css">
...
<div class="row gy-4">
    ...
    <table class="table-bordered text-white w-90">
        ...
        <tbody>
            ...
            <tr id="linha3">
                <td class="text-start">
                    <span>\(A_2, A_1, A_0 \gets \text{divida } X \text{ em três partes de tamanho } q\)</span>
                </td>
            </tr>
            <tr id="linha4">
                <td class="text-start">
                    <span>\(B_2, B_1, B_0 \gets \text{divida } Y \text{ em três partes de tamanho } q\)</span>
                </td>
            </tr>
            <tr id="linha5">
                <td class="text-start">
...
<!-- Custom Script -->
<script src="/static/app/js/toomcook3/script.js"></script>