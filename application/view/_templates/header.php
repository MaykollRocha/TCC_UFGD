...
<head>
    ...
    <style>
        ...
        /* O conte√∫do principal deve ocupar o espa√ßo restante sem ultrapassar o footer */
        main {
            flex-grow: 1;
        }

        /* O rodap√© deve ficar fixo no fundo */
        footer {
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
        <div class="container-fluid">
            ...
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarMenu"
                aria-controls="navbarMenu" aria-expanded="false" aria-label="Alternar navegaÁ„o">
